...
class MaxTree(ComponentTree):
	"""
	This class represents a *max-tree*, with a root node and a list of nodes (ComponentTreeNode).
	...
	def build_component_tree(self, image: np.ndarray, invert_image: bool) -> None:
		"""
		Builds a *component-tree* (max-tree) using an implementation based on Najman's algorithm published in :
		*L. Najman, M. Croupie, "Building the component-tree in quasi-linear time", Vol. 15, Num. 11, p. 3531-3539, 2006*.
		...
		invert_image: bool
			Use set to *True*, then the **image** is inverted before computation.
	...
	def build_component_tree_from_partial_image(self, image: np.ndarray, mask:np.ndarray, invert_image: bool) -> None:
		"""
		Builds a partial *component-tree* (max-tree) on a given set of pixels using an implementation based on Najman's algorithm published in :
		*L. Najman, M. Croupie, "Building the component-tree in quasi-linear time", Vol. 15, Num. 11, p. 3531-3539, 2006*.
		...
		invert_image: bool
			If set to *True*, the **image** is inverted before computation.
